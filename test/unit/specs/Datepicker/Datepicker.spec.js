...
describe('Datepicker mounted', () => {
  ...
  it('resets the default page date', () => {
    ...
    expect(wrapper.vm.pageDate[0].getDate()).toEqual(1)
  ...
  it('does not set the default page date if a date is selected', () => {
    ...
    wrapper.vm.resetDefaultPageDate()
    expect(wrapper.vm.pageDate[0].getFullYear()).toEqual(pastDate.getFullYear())
    expect(wrapper.vm.pageDate[0].getMonth()).toEqual(pastDate.getMonth())
    expect(wrapper.vm.pageDate[0].getDate()).toEqual(1)
  })
